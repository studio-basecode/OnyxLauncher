...
public class GLFW
{
    ...
    /* volatile */ public static GLFWPreeditCallbackI mGLFWPreeditCallback;
    /* volatile */ public static GLFWIMEStatusCallbackI mGLFWIMEStatusCallback;
    ...
    */
    ...
    public static int glfwGetInputMode(@NativeType("GLFWwindow *") long window, int mode) {
        ...
        return value != null ? value : glfwGetDefaultInputMode(mode);
    }

    private static int glfwGetDefaultInputMode(int mode) {
        switch (mode) {
            case GLFW_CURSOR:
