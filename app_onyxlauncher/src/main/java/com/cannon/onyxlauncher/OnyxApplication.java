...
import com.cannon.onyxlauncher.tasks.AsyncAssetManager;
import com.cannon.onyxlauncher.utils.*;
import com.cannon.onyxlauncher.utils.FileUtils;

public class OnyxApplication extends Application {
	public static final String CRASH_REPORT_TAG = "OnyxCrashReport";
	...
	public void onCreate() {
		...
		Thread.setDefaultUncaughtExceptionHandler((thread, th) -> {
			boolean storagePermAllowed = (Build.VERSION.SDK_INT < 23 || Build.VERSION.SDK_INT >= 29 ||
					ActivityCompat.checkSelfPermission(OnyxApplication.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) && Tools.checkStorageRoot(OnyxApplication.this);
			...
			try {
				...
				crashStream.append("OnyxLauncher crash report\n");
			...
			FatalErrorActivity.showError(OnyxApplication.this, crashFile.getAbsolutePath(), storagePermAllowed, th);
			Tools.fullyExit();
		});
