package com.cannon.onyxlauncher.plugins;
...
public class FFmpegPlugin {
    ...
    public static void discover(Context context) {
        ...
        try {
            PackageInfo ffmpegPluginInfo = manager.getPackageInfo("com.cannon.onyxlauncher.ffmpeg", PackageManager.GET_SHARED_LIBRARY_FILES);
