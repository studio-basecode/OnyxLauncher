...
import com.cannon.onyxlauncher.modloaders.FabricVersion;
...
import com.cannon.onyxlauncher.modloaders.modpacks.SelfReferencingFuture;
...
public abstract class FabriclikeInstallFragment extends Fragment implements ModloaderDownloadListener, CompoundButton.OnCheckedChangeListener {
    ...
    private void updateLoaderVersions() {
        startLoading();
        mLoaderVersionFuture = new SelfReferencingFuture(new LoadLoaderVersionsTask()).startOnExecutor(OnyxApplication.sExecutorService);
    }
    ...
    private void updateGameVersions() {
        startLoading();
        mGameVersionFuture = new SelfReferencingFuture(new LoadGameVersionsTask()).startOnExecutor(OnyxApplication.sExecutorService);
    }
