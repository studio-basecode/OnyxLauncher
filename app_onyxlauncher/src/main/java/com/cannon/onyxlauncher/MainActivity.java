...
import static com.cannon.onyxlauncher.Tools.dialogForceClose;
import static com.cannon.onyxlauncher.prefs.LauncherPreferences.PREF_ENABLE_GYRO;
import static com.cannon.onyxlauncher.prefs.LauncherPreferences.PREF_SUSTAINED_PERFORMANCE;
import static com.cannon.onyxlauncher.prefs.LauncherPreferences.PREF_USE_ALTERNATE_SURFACE;
import static com.cannon.onyxlauncher.prefs.LauncherPreferences.PREF_VIRTUAL_MOUSE_START;
...
import com.cannon.onyxlauncher.customcontrols.ControlButtonMenuListener;
import com.cannon.onyxlauncher.customcontrols.ControlData;
import com.cannon.onyxlauncher.customcontrols.ControlDrawerData;
import com.cannon.onyxlauncher.customcontrols.ControlJoystickData;
import com.cannon.onyxlauncher.customcontrols.ControlLayout;
import com.cannon.onyxlauncher.customcontrols.CustomControls;
import com.cannon.onyxlauncher.customcontrols.EditorExitable;
import com.cannon.onyxlauncher.customcontrols.keyboard.LwjglCharSender;
import com.cannon.onyxlauncher.customcontrols.keyboard.TouchCharInput;
import com.cannon.onyxlauncher.customcontrols.mouse.GyroControl;
import com.cannon.onyxlauncher.customcontrols.mouse.HotbarView;
import com.cannon.onyxlauncher.customcontrols.mouse.Touchpad;
import com.cannon.onyxlauncher.lifecycle.ContextExecutor;
import com.cannon.onyxlauncher.prefs.LauncherPreferences;
import com.cannon.onyxlauncher.prefs.QuickSettingSideDialog;
import com.cannon.onyxlauncher.services.GameService;
...
public class MainActivity extends BaseActivity implements ControlButtonMenuListener, EditorExitable, ServiceConnection {
        ...
        try {
            ...
            minecraftGLView.setSurfaceReadyListener(() -> {
                try {
                    ...
                    runOnUiThread(MainActivity.this::startPlaytimeTracking);
                    runCraft(finalVersion, mVersionInfo);
                } catch (Throwable e) {
                    Tools.showErrorRemote(e);
                } finally {
                    runOnUiThread(MainActivity.this::stopPlaytimeTracking);
                }
            });
        } catch (Throwable e) {
    ...
    private void startPlaytimeTracking() {
        ...
        mPlaytimeRunnable = new Runnable() {
            @Override
            public void run() {
                savePlaytimeSnapshot(false);
                if (mPlaytimeHandler != null) {
                    mPlaytimeHandler.postDelayed(this, PLAYTIME_TICK_MS);
                }
            }
        };
        mPlaytimeHandler.postDelayed(mPlaytimeRunnable, PLAYTIME_TICK_MS);
        Log.i("PlaytimeTracker", "Playtime tracking started.");
    }

    private void stopPlaytimeTracking() {
        if (mPlaytimeHandler != null && mPlaytimeRunnable != null) {
            mPlaytimeHandler.removeCallbacks(mPlaytimeRunnable);
            mPlaytimeRunnable = null;
            mPlaytimeHandler = null;
        }
        savePlaytimeSnapshot(true);
        mSessionStartTimeMs = 0;
        Log.i("PlaytimeTracker", "Playtime tracking stopped.");
    }
    ...
    private void runCraft(String versionId, JMinecraftVersionList.Version version) throws Throwable {
        ...
        MinecraftAccount minecraftAccount = OnyxProfile.getCurrentProfileContent(this, null);
