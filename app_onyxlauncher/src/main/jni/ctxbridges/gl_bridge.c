...
gl_render_window_t* gl_init_context(gl_render_window_t *share) {
    ...
    if(libgl_es >= 3) renderable_type |= EGL_OPENGL_ES3_BIT_KHR;
    EGLint egl_attributes[] = { EGL_BLUE_SIZE, 8, EGL_GREEN_SIZE, 8, EGL_RED_SIZE, 8, EGL_ALPHA_SIZE, 8, EGL_DEPTH_SIZE, 24, EGL_SURFACE_TYPE, EGL_WINDOW_BIT|EGL_PBUFFER_BIT, EGL_RENDERABLE_TYPE, renderable_type, EGL_NONE };
...

    {
        ...
        if (pojav_environ->config_renderer == RENDERER_VK_ZINK) {
            printf("EGLBridge: Binding to desktop OpenGL (Zink)\n");
...
Java_org_lwjgl_opengl_OnyxRendererInit_nativeInitGl4esInternals(JNIEnv *env, jclass clazz,
